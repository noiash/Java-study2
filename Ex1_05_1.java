...
class Ex1_05_1 {
	public static void main (String[] args) {
		int itLifetimeWage = 262870000;	//IT業界の生涯賃金
		long itMarketSize = 2800000000L; //IT業界の市場規模
		//キャラと読む　↓
		char favoriteKanji = '乃'; //自分の好きな漢字１文字
		String wantToBeOccupation = "エンジニア"; //自分のなりたい職業
